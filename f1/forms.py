...
from f1.models import UserProfile, DriverRating, CarRating, ConstructorRating
...
class DriverRatingForm(forms.ModelForm):
    ...
    class Meta:
        model = DriverRating
        fields(overallAverage,personality,aggressiveness,awareness,experience,starts,pace,racecraft)
