...
def populate():
    ...
    driver_list = [
        ...
        {'name': 'Valtteri Bottas', 'DOB': '28/08/1989', 'height': '1.73m', 'weight': '69kg',
         ...
         'constructor': 'Alfa Romeo F1 Team Orlen'},
    ...
    car_list = [
        {'model': 'Mercedes-AMG W13 E Performance', 'horsepower': '740bhp',
         ...
         'gearbox': 'Paddle Operated 8 speed Automatic', 'constructor': 'Mercedes AMG Petronas F1 Team'},
        {'model': 'Red Bull Racing RB18', 'horsepower': '740bhp', 'engine': 'HRC 90º V6', 'weight': '1,753lbs',
         'gearbox': 'Paddle Operated 8 speed Automatic', 'constructor': 'Oracle Red Bull Racing'},
        {'model': 'McLaren MCL36 Mercedes', 'horsepower': '740bhp',
         'engine': 'Mercedes-AMG F1 M13 E Performance 90º V6', 'weight': '1,753lbs',
         'gearbox': 'Paddle Operated 8 speed Automatic', 'constructor': 'McLaren F1 Team'},
        {'model': 'Ferrari SF-75', 'horsepower': '740bhp', 'engine': 'Tipo 066/7 90º V6', 'weight': '1,753lbs',
         'gearbox': 'Paddle Operated 8 speed Automatic', 'constructor': 'Scuderia Ferrari'},
        {'model': 'Alpine A522 Renault', 'horsepower': '740bhp', 'engine': 'Renault E22 90º V6',
         'weight': '1,753lbs', 'gearbox': 'Paddle Operated 8 speed Automatic', 'constructor': 'Alpine F1 Team'},
        {'model': 'AlphaTauri AT03', 'horsepower': '740bhp', 'engine': 'HRC 90º V6', 'weight': '1,753lbs',
         'gearbox': 'Paddle Operated 8 speed Automatic', 'constructor': 'Scuderia AlphaTauri'},
        {'model': 'Aston Martin AMR22 Mercedes', 'horsepower': '740bhp',
         'engine': 'Mercedes-AMG F1 M13 E Performance 90º V6', 'weight': '1,753lbs',
         'gearbox': 'Paddle Operated 8 speed Automatic', 'constructor': 'Aston Martin Aramco Cognizant F1 Team'},
        {'model': 'Williams FW44 Mercedes', 'horsepower': '740bhp',
         'engine': 'Mercedes-AMG F1 M13 E Performance 90º V6', 'weight': '1,753lbs',
         'gearbox': 'Paddle Operated 8 speed Automatic', 'constructor': 'Williams Racing'},
        {'model': 'Haas VF-22 Ferrari', 'horsepower': '740bhp', 'engine': 'Ferrari Tipo 066/7 90º V6',
         'weight': '1,753lbs', 'gearbox': 'Paddle Operated 8 speed Automatic', 'constructor': 'Haas F1 Team'},
